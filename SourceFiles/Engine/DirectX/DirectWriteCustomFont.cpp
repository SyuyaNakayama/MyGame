...
public:
	...
	(
		...
		[[maybe_unused]] void const* collectionKey,
		[[maybe_unused]] UINT32 collectionKeySize,
...
// 初期化処理
HRESULT DirectWriteCustomFont::Init([[maybe_unused]] IDXGISwapChain* swapChain)
{
	HRESULT result = S_OK;
...
HRESULT DirectWriteCustomFont::SetFont(WCHAR const* fontname, DWRITE_FONT_WEIGHT fontWeight, DWRITE_FONT_STYLE fontStyle,
	...
	[[maybe_unused]] DWRITE_TEXT_ALIGNMENT textAlignment, D2D1_COLOR_F Color, D2D1_COLOR_F shadowColor, [[maybe_unused]] D2D1_POINT_2F shadowOffset)
{
	HRESULT result = S_OK;
...
// options：テキストの整形
//====================================
HRESULT DirectWriteCustomFont::DrawString(std::string str, const Vector2& pos, D2D1_DRAW_TEXT_OPTIONS options, bool shadow)
{
	HRESULT result = S_OK;
